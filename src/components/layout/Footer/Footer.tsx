...
export default function Footer() {
  ...
  const footerSections = [
    {
      ...
      title: "About",
      links: [
        { href: "/history", text: "Depuis 1923" },
        { href: "/magazine", text: "Le Magazine" },
    ...
    },
    {
      ...
      title: "Media",
      links: [
        { href: "/brochure", text: "E-Brochure" },
        { href: "/videos", text: "Galerie vidéos" },
        { href: "/photos", text: "Galerie photos" },
      ],
    },
    {
      id: "info",
  ...
  return (
    <footer className="text-white pt-8 pb-4 bg-black/80 rounded-t-2xl">
      <div className="container mx-auto px-4">
        ...
        <div className="md:hidden space-y-2 mb-8">
          {footerSections.map((section) => (
            <div key={section.id} className="border-b border-white/20">
              ...
              >
                <h3 className="text-amber-300 font-medium">{section.title}</h3>
                <ChevronDown
                  size={18}
        ...
        <div className="max-w-md mx-auto mb-8">
          <h3 className="text-center text-amber-300 font-medium mb-3">
          ...
          <form className="flex flex-col sm:flex-row gap-2">
            <input
              ...
              className="flex-grow px-4 py-2 bg-white/10 border border-white/30 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-300 text-white"
              required
            />
            <button
              type="submit"
              className="px-4 py-2 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-md transition-colors duration-300"
            >
              Subscribe
            </button>
          </form>
        ...
        {/* Copyright section */}
        <div className="text-center text-sm text-white/60 pt-6 border-t border-white/20">
          <p className="mb-2">
